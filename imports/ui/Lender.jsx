  ...
  return (
    <div className=''>
      <div className='w-full'>
        <h1 className='text-xl font-light border-b mb-4 text-green-700'>
          ...
          {activeLoans.length === 0 ? (
            ...
            activeLoans.map((loan) => (
              <div className='flex w-full justify-between items-center' key={loan._id}>
                ...
                <button
                  className='bg-green-700 text-white px-3 py-2 rounded-lg mt-3'
        ...
        <h1 className='text-xl font-light border-b mb-4 mt-6 text-green-700'>
